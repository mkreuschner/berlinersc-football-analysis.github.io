...
<div class="panel">
  ...
  <tr>
    <td>Generell</td>
    <td>Stern Britz ist defensiv sehr anfällig, hat sich aber in den letzten Spielen stabilisiert</td>
  </tr>
  <tr>
    <td>Platz</td>
    <td>größerer KuRa. Sie sind heimstark. Alle drei Siege haben sie zu Hause geholt</td>
  </tr>
  <tr>
    <td>Formation</td>
    <td>wahrscheinlich: 4-2-3-1 (siehe unten)</td>
  </tr>
  <tr>
    <td>Abwehr</td>
    <td>vermutlich mit 4er Kette</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>def Standards</td>
    <td>bekommen viele Gegentore auch durch Verteidiger, schwach vermutlich</td>
  </tr>
  <tr>
    <td>off Standards</td>
    <td>meiste Tore über Offensive Spieler</td>
  </tr>
  </table>
  </p>
</div>
