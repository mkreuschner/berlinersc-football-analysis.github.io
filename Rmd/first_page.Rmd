...
formatted_games <- formatted_games %>%
  mutate(
    Heim = cell_spec(Heim,
                      color = case_when(
                       Heim == MeinTeam ~ "black",   # Hintergrundfarbe für "BSC"
                       Heim == Gegner ~ "black",   # Hintergrundfarbe für "STR"
                       TRUE ~ ""            # Keine Hintergrundfarbe sonst
                     ),
                     background = case_when(
                       Heim == MeinTeam ~ "yellow",   # Hintergrundfarbe für "BSC"
                       Heim == Gegner ~ "yellow",   # Hintergrundfarbe für "STR"
                       TRUE ~ "transparent"            # Keine Hintergrundfarbe sonst
                     )),
    Auswärts = cell_spec(Auswärts,
                      color = case_when(
                       Auswärts == MeinTeam ~ "black",   # Hintergrundfarbe für "BSC"
                       Auswärts == Gegner ~ "black",   # Hintergrundfarbe für "STR"
                       TRUE ~ ""            # Keine Hintergrundfarbe sonst
                     ),
                     background = case_when(
                       Auswärts == MeinTeam ~ "yellow",   # Hintergrundfarbe für "BSC"
                       Auswärts == Gegner ~ "yellow",   # Hintergrundfarbe für "STR"
                       TRUE ~ "transparent"            # Keine Hintergrundfarbe sonst
                     ))
  )
...
formatted_games <- data.frame(
  "Spieltag" = c(14,14,14,14,14,14,14,14,15),
  "Team1" = c("BFC Preussen II","SV Stern Britz 1889", "BFC Meteor 06", "Köpenicker FC", "BSV Eintracht Mahlsdorf II",  "FSV Berolina Stralau 1901", "SC Borsigwalde 1910", "SV Empor Berlin II" , "TSV Rudow Berlin" ),
  "Team2" = c("BSV Al-Dersimspor", "FC Viktoria 1889 Berlin II", "FC Internationale Berlin 1980",  "Berliner SC II", "Berliner SV 1892", "Türkiyemspor Berlin",  "TSV Rudow Berlin", "VfB Concordia Britz 1916", "BSV Al-Dersimspor" ),
  H = "_",
  A = "_"
)
  ...
  mutate(
    ...
    team = cell_spec(team, 
                      color = case_when(
                       ...
                       team == Gegner ~ "black",   # Hintergrundfarbe für "STR"
                       TRUE ~ ""            # Keine Hintergrundfarbe sonst
                     ),                                         
                     background = case_when(
                       team == "BSC" ~ "yellow",   # Hintergrundfarbe für "BSC"
                       team == Gegner ~ "yellow",   # Hintergrundfarbe für "STR"
                       TRUE ~ "transparent"            # Keine Hintergrundfarbe sonst
                     ))
  )
...
const defaultTabelleTab = document.querySelector("#myLink");
