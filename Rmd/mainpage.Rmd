...
<style>
    ...
    .accordion {
      ...
      #Letzte { background-color: black;}
      #Nächste {background-color: black;}
...
<div class="panel">
<br>
    <button class="tablink spiele" data-tab="Letzte" data-group="spiele" id="defaultSpieleOpen">Letzte</button>
    <button class="tablink spiele" data-tab="Nächste" data-group="spiele">Nächste</button>
<br>
<div id="Letzte" class="tabcontent spiele" style="display: none;">
```{R echo = FALSE, results='markup'}
...
<div id="Nächste" class="tabcontent spiele" style="display: none;">
```{R echo = FALSE, results='markup'}
...
<div class="panel">
<br>
    <button class="tablink tabelle" data-tab="Gesamt" data-group="tabelle" id="defaultTabelleOpen">Gesamt</button>
    <button class="tablink tabelle" data-tab="Heim" data-group="tabelle">Heim</button>
    <button class="tablink tabelle" data-tab="Auswärts" data-group="tabelle">Auswärts</button>
    <button class="tablink tabelle" data-tab="Form" data-group="tabelle">Form</button>
<br> 
<div id="Gesamt" class="tabcontent tabelle" style="display: none;">
```{R echo = FALSE, results='markup'}
...
<div id="Heim" class="tabcontent tabelle" style="display: none;">
```{R echo = FALSE, results='markup'}
...
<div id="Auswärts" class="tabcontent tabelle" style="display: none;">
```{R echo = FALSE, results='markup'}
...
<div id="Form" class="tabcontent tabelle" style="display: none;">
```{R echo = FALSE, results='markup'}
...
formatted_form %>%
  kbl(align = "c", escape = FALSE) %>% # Escape auf FALSE setzen, um HTML zu rendern
  kable_styling(full_width = FALSE, bootstrap_options = c("condensed","responsive","hover")) %>%
  row_spec(0, bold = TRUE, background = "#232323")
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        accordions.forEach(accordion => {
            accordion.addEventListener("click", function () {
                ...
                // Show or hide the associated panel
        ...
        // Tab functionality
        function openTab(event, tabName, tabGroup) {
            const tablinks = document.querySelectorAll(`.tablink.${tabGroup}`);
            const tabcontents = document.querySelectorAll(`.tabcontent.${tabGroup}`);
            // Hide all tabs in the group
            tabcontents.forEach(content => content.style.display = "none");
            // Remove active class from all buttons in the group
            tablinks.forEach(link => link.classList.remove("active"));
            // Show the clicked tab and set the button to active
        ...
        document.querySelectorAll('.tablink').forEach(button => {
            button.addEventListener('click', function (event) {
                const tabName = this.dataset.tab; // Get the tab name
                const tabGroup = this.dataset.group; // Get the tab group
                openTab(event, tabName, tabGroup); // Call openTab with the arguments
            });
        });
        // Set defaults on page load
        const firstAccordion = document.querySelector(".accordion");
        if (firstAccordion) {
            firstAccordion.click(); // Open the first accordion by default
        }
        const defaultSpieleTab = document.querySelector("#defaultSpieleOpen");
        if (defaultSpieleTab) {
            defaultSpieleTab.click(); // Open the default Spiele tab
        }
        const defaultTabelleTab = document.querySelector("#defaultTabelleOpen");
        if (defaultTabelleTab) {
            defaultTabelleTab.click(); // Open the default Tabelle tab
        }
    });
</script>
<body>
