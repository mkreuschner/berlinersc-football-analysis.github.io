...
matchday_data <- read_csv("/Users/mkreuschnervsp/Desktop/BSC/Spieltag12.csv")
player_data <- read.table("/Users/mkreuschnervsp/Desktop/BSC/fupa2425_player_data_12.csv", sep=",", header=TRUE, stringsAsFactors = FALSE, fileEncoding = "UTF-8")
...
formatted_table <- formatted_table %>%
   mutate(team = case_when(
     formatted_table$team == "BFC Meteor 06" ~ "MET",
     formatted_table$team == "TSV Rudow Berlin" ~ "RUD",
     formatted_table$team == "BSV Eintracht Mahlsdorf II" ~ "MAH",
     formatted_table$team == "BFC Preussen II" ~ "PRE",
     formatted_table$team == "SC Borsigwalde 1910" ~ "BOR",
     formatted_table$team == "FC Internationale Berlin 1980" ~ "INT",
     formatted_table$team == "Berliner SV 1892" ~ "BSV",
     formatted_table$team == "Berliner SC II" ~ "BSC",
     formatted_table$team == "Türkiyemspor Berlin" ~ "TUR",    
     formatted_table$team == "BSV Al-Dersimspor" ~ "ALD",
     formatted_table$team == "FC Viktoria 1889 Berlin II" ~ "VIK",
     formatted_table$team == "FSV Berolina Stralau 1901" ~ "STR",
     formatted_table$team == "Köpenicker FC" ~ "KOP",
     formatted_table$team == "SV Stern Britz 1889" ~ "BRI",
     formatted_table$team == "SV Empor Berlin II" ~ "EMP",
     formatted_table$team == "VfB Concordia Britz 1916" ~ "CON",TRUE ~ formatted_table$team))
