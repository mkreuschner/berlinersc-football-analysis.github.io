...
// Spieltag-CSV-Datei laden und Teamnamen ersetzen
function loadMatchdayCSV(filePath) {
    Papa.parse(filePath, {
        ...
        complete: function (results) {
            ...
            data = replaceTeamNames(data, ["Heimteam", "Auswärtsteam"]);
            displayData(data, matchdayContainer, ["Spieltag", "Heimteam", "Auswärtsteam", "Ergebnis"]);
        },
...
// Tabellen-CSV-Datei laden und Teamnamen ersetzen
function loadTableCSV(filePath) {
    Papa.parse(filePath, {
        ...
        complete: function (results) {
            ...
            displayData(data, tableContainer, null);
        },
        error: function (error) {
            console.error("Fehler beim Laden der CSV-Datei:", error);
...
const teamNameMapping = {
    ...
    "Türkiyemspor Berlin": "Türkiyemspor",
