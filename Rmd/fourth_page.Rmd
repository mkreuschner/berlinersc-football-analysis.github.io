...
<option value="3-4-3">4-3-3</option>
...
const formations = {
  "4-4-2": [
    { position: "TW", x: "43%", y: "85%" },
    { position: "RV", x: "15%", y: "70%" },
    { position: "IV", x: "40%", y: "70%" },
    { position: "IV", x: "60%", y: "70%" },
    { position: "LV", x: "85%", y: "70%" },
    { position: "RM", x: "20%", y: "55%" },
    { position: "ZM", x: "40%", y: "55%" },
    { position: "ZM", x: "60%", y: "55%" },
    { position: "LM", x: "80%", y: "55%" },
    { position: "ST", x: "35%", y: "40%" },
    { position: "ST", x: "65%", y: "40%" }
  ]
};
